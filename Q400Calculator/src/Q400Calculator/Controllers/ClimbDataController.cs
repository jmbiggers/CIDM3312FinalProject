...
{
    public class ClimbDataController : Controller
    {
        private readonly ApplicationDbContext _context;

        public ClimbDataController(ApplicationDbContext context)
        {
            _context = context;    
        }
        ...
        // GET: ClimbData/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: ClimbData/Create
